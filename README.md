...
Приложение для macOS: блокирует управление Mac и скрывает экран, **не переводя Mac в сон**. Claude Code, сборки, загрузки и другие фоновые задачи продолжают работать. Разблокировка через Touch ID или системный запрос пароля.
...
Приложение живёт в строке меню (иконка щита) → **Lock Now**.
